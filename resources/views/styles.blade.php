                            ...
                            <div class="style-detail-col">
                                ...
                                <div class="style-detail-thumb">
                                    ...
                                    <div class="image-thumb-box">
                                        <input type='radio' name='style_image_clr' class='color-thumb black-color' onclick="change_product_color({{$product->id}})">
                                        <span class="form-check-label color-thumb black-color"></span>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
