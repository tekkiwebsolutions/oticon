<?php namespace App\Http\Controllers;
	...
	class AdminSocialMediaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Url Link","name"=>"url_link"];
			...
			$this->form[] = ['label'=>'Url Link','name'=>'url_link','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Url Link","name"=>"url_link","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
