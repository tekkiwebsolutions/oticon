                ...
                <div class="login-section">
                    ...
                    <form class="login-form" method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="col-lg-12 col-md-12 col-12 position-relative form-row">
                            <input type="email" class="form-control textbox @error('email') is-invalid @enderror" id="email" placeholder="Enter Your Email Address" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="col-lg-12 col-md-12 col-12 position-relative form-row">
                            <input type="password" class="form-control textbox @error('password') is-invalid @enderror" id="password" placeholder="Enter Your Password" name="password">
                            <span class="textbox-icon"><img alt="" class="img-fluid" src="{{asset('images/lock-icon.png')}}"></span>
                            @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-lg-12 col-md-12 col-12 position-relative form-row">
                            ...
                            <input type="password" class="form-control textbox @error('email') is-invalid @enderror" id="password_confirmation" placeholder="Enter Your Confirm Password" name="password_confirmation">
                            <span class="textbox-icon"><img alt="" class="img-fluid" src="{{asset('images/lock-icon.png')}}"></span>
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
