...
! function() {
    ...
    function b(b) {
        ...
        function y() {
            ...
            for (var b = 0; f > b; b++) a = d.getElementsByTagName("img")[b], a.style.display = "none", a.style.width = "100%", a.setAttribute("src", a.getAttribute("data-src")), a.setAttribute("data-index", b), a.removeAttribute("data-src"), x(a);
