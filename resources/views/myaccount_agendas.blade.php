                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class='reports-notifications' id="alert_msg">
                            ...
                            <p>Agendas will expire within {{$siteData->agendas_exp}} day(s)</p>
                        ...
                        <div class='agendas'>
                            ...
                            <div class="myaccount_agendas_cover">
                                <table class="table table-reponsive table-data myaccount-agendas">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class=' icons'>
                                                <a href="{{route('delete_agendas', $agenda->id)}}" onclick="return confirm('Are you sure?')" >
