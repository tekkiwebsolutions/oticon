                            ...
                            <div class="custom-selectbox email-select">
                                <div class="d-flex">
                                    <div class="form-check custom-radio">
                                        <input class="form-check-input" type="radio" name="email_notification" id="flexRadioDefault1" value="0" @if($data->disabled_notification == 0) checked @endif >
                                        <label class="form-check-label" for="flexRadioDefault1">Enable</label>
                                    </div>
                                    <div class="form-check custom-radio">
                                        <input class="form-check-input" type="radio" name="email_notification" id="flexRadioDefault2" value="1" @if($data->disabled_notification == 1) checked @endif >
