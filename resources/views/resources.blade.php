                    ...
                    <div class="col-lg-12 col-md-12 col-12 pb-4">
                        ...
                        <div class="row">
                            <div class="col-lg-9 col-md-9 col-12">
                                <h3 class="resources-heading">{{$resources->title}}</h3>
                            </div>
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 questionnaires_block">
                            ...
                            <form method="POST" action="{{ url('save_questionnaires') }}">
                                ...
                                <div class="alert alert-danger" role="alert" id="alert_msg">
                                    {{$errors->first()}}
                                    <a href="javascript:voide(0)" onclick="$('#alert_msg').remove()" class="close" data-dismiss="alert"><img src="{{url('images/close.png')}}" class="img-fluid"></a>
                                </div>
                                @endif
