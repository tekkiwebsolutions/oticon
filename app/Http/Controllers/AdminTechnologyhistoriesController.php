<?php namespace App\Http\Controllers;
	...
	class AdminTechnologyhistoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "technologyhistories";
			...
			$this->form[] = ['label'=>'Images','name'=>'images','type'=>'upload','validation'=>'required','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Age Group Id","name"=>"age_group_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"age_group,title"];
